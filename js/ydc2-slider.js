...
jQuery(document).ready(function ($) {
    ...
    var params = {
        'q' : 'resource:"Resource available online" AND institution:"Yale Center for British Art" AND author:"George Romney"',
        'rows' : 100
    };
    for (var e in params) {
